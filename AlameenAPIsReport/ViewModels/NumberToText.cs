...
class ConvertNumbersToArabicAlphabet
   {
       ...
       public  ConvertNumbersToArabicAlphabet(string Number, string n)
      {
            NameCur = n;
            if (Number[0] == '-')
            {
       ...
       private string ConvertNumberToAlpha(string Number)
       {
           if (Number.Contains('.'))
           {
               ...
               else
               {
                   ...
                   {
                       case 1: return convertOneDigits(Number.ToString())  + NameCur + " و " + convertTwoDigits(Number.Split('.')[1]) + " قرشا ";
                       case 2: return convertTwoDigits(Number.ToString())  + NameCur + " و " + convertTwoDigits(Number.Split('.')[1]) + " قرشا ";
                       case 3: return convertThreeDigits(Number.ToString())+ NameCur + " و " + convertTwoDigits(Number.Split('.')[1]) + " قرشا ";
                       case 4: return convertFourDigits(Number.ToString()) + NameCur + " و " + convertTwoDigits(Number.Split('.')[1]) + " قرشا ";
                       case 5: return convertFiveDigits(Number.ToString()) + NameCur + " و " + convertTwoDigits(Number.Split('.')[1]) + " قرشا ";
                       case 6: return convertSixDigits(Number.ToString())  + NameCur + " و " + convertTwoDigits(Number.Split('.')[1]) + " قرشا ";
                       default: return "";
                   }
               }
           }
           else
           {
               ...
               else
               {
                   ...
                   {
                    case 1: return convertOneDigits(Number.ToString())     + " " + NameCur ;
                       case 2: return convertTwoDigits(Number.ToString())  + " " + NameCur ;
                       case 3: return convertThreeDigits(Number.ToString())+ " " + NameCur ;
                       case 4: return convertFourDigits(Number.ToString()) + " " + NameCur ;
                       case 5: return convertFiveDigits(Number.ToString()) + " " + NameCur ;
                       case 6: return convertSixDigits(Number.ToString())  + " " + NameCur ;
                       default: return "";
                   }
